...
pip install -U jupyter environment_kernels jupyterlab jupyter_ai jupyter_ai_magics jupyter_contrib_nbextensions notebook_shim python-language-server powershell_kernel bash_kernel jupyterthemes cython
