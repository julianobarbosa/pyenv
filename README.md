...
```console
pyenv virtualenv 3.8.3 jupyter3 && \
pyenv virtualenv 3.8.3 tools3 && \
...
pip install -U pynvim flake8 jedi autopep8 pep8 pyflakes isort yapf
...
# Enable
```console
pyenv global 3.8.3 2.7.16 jupyter3 ipython2 tools3 tools2 neovim3 neovim2
```
