...
```console
pyenv virtualenv 3.9.4 jupyter3 && \
pyenv virtualenv 3.9.4 tools3 && \
...
pip install -U ansible colorama cookiecutter gnucash-to-beancount jrnl mps-youtube rows speedtest-cli fast.com zabbix-api youtube-dl tmuxp 
...
# Enable
```console
pyenv global 3.9.4 2.7.18 jupyter3 ipython2 tools3 tools2 neovim3 neovim2
```
